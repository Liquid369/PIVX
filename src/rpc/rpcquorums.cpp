...
UniValue signsigningsession(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || (request.params.size() != 3)) {
        throw std::runtime_error(
            "signsigningsession llmqType \"id\" \"msgHash\"\n"
            "\nArguments:\n"
            ...
            "\nExample:\n" +
            HelpExampleRpc("signsigningsession", "100 \"xxx\", \"xxx\"") + HelpExampleCli("signsigningsession", "100 \"xxx\", \"xxx\""));
    }
...
{ //  category       name                      actor (function)      okSafe argNames
  //  -------------- ------------------------- --------------------- ------ --------
    ...
    {"hidden",       "signsigningsession",     &signsigningsession,  true,  {"llmqType", "id", "msgHash"}},
